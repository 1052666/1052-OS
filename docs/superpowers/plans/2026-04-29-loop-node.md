...
| Modify | `frontend/src/contracts/schemas.ts`、`frontend/src/data/api.ts` | 前端契约与数据访问同步后端变更 |
...
**Files:**
- Modify: `frontend/src/contracts/schemas.ts`
...
```bash
git add frontend/src/contracts/schemas.ts frontend/src/data/api.ts
