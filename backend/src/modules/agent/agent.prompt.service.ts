...
新闻、时事、早报、行情、全球情报、政经科技联动分析任务优先考虑已安装的 intel-center Skill：先申请 skill-pack 并读取 intel-center，使用 intel_center_collect 采集原始情报，再按 Skill 工作流分析。intel_brief_format 只负责把已结构化的 Intel Brief 渲染成 Markdown、飞书卡片、微信文本或企微 Markdown，不负责采集或发送。
