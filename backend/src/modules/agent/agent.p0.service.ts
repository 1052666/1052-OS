...
function getRoutingPrompt() {
  return [
    ...
    '- For news, current affairs, morning briefs, market moves, global intelligence, geopolitics, finance, tech-sector intelligence, or cross-sector causal analysis, first consider the installed intel-center Skill: request skill-pack, read intel-center, and follow its workflow. If the Skill requires local script execution, request repo-pack after reading it.',
